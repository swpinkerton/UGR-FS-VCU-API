...
void ugr_vcu_api_vcu2ai_set_data(ugr_vcu_api_vcu2ai *data) {
    ...
    float t_VCU2AI_FRONT_AXLE_TORQUE_MAX_nm = 0;
    float t_VCU2AI_REAR_AXLE_TORQUE_MAX_nm = (0.1f*VCU2AI_REAR_AXLE_TORQUE_MAX_raw);
    float t_VCU2AI_STEER_ANGLE_MAX_deg = (0.1f*VCU2AI_STEER_ANGLE_MAX_raw);
...
//    t_VCU2AI_FRONT_AXLE_TORQUE_MAX_nm = data->VCU2AI_FRONT_AXLE_TORQUE_MAX_nm;
//    t_VCU2AI_REAR_AXLE_TORQUE_MAX_nm = data->VCU2AI_REAR_AXLE_TORQUE_MAX_nm;
    t_VCU2AI_STEER_ANGLE_deg = data->VCU2AI_STEER_ANGLE_deg;
    t_VCU2AI_STEER_ANGLE_MAX_deg = data->VCU2AI_STEER_ANGLE_MAX_deg;
    t_VCU2AI_BRAKE_PRESS_F_pct = data->VCU2AI_BRAKE_PRESS_F_pct;
    t_VCU2AI_BRAKE_PRESS_R_pct = data->VCU2AI_BRAKE_PRESS_R_pct;
    t_VCU2AI_FL_WHEEL_SPEED_rpm = data->VCU2AI_FL_WHEEL_SPEED_rpm;
    t_VCU2AI_FR_WHEEL_SPEED_rpm = data->VCU2AI_FR_WHEEL_SPEED_rpm;
    t_VCU2AI_RL_WHEEL_SPEED_rpm = data->VCU2AI_RL_WHEEL_SPEED_rpm;
    t_VCU2AI_RR_WHEEL_SPEED_rpm = data->VCU2AI_RR_WHEEL_SPEED_rpm;
    t_VCU2AI_FL_PULSE_COUNT = data->VCU2AI_FL_PULSE_COUNT;
    t_VCU2AI_FR_PULSE_COUNT = data->VCU2AI_FR_PULSE_COUNT;
    t_VCU2AI_RL_PULSE_COUNT = data->VCU2AI_RL_PULSE_COUNT;
    t_VCU2AI_RR_PULSE_COUNT = data->VCU2AI_RR_PULSE_COUNT;
    ...
    //not sure if this is how steer angle is parsed on this end
    if(t_VCU2AI_STEER_ANGLE_deg > t_VCU2AI_STEER_ANGLE_MAX_deg) { t_VCU2AI_STEER_ANGLE_deg = t_VCU2AI_STEER_ANGLE_MAX_deg; }
    if(t_VCU2AI_STEER_ANGLE_deg < (-1.0f*t_VCU2AI_STEER_ANGLE_MAX_deg)) { t_VCU2AI_STEER_ANGLE_deg = (-1.0f*t_VCU2AI_STEER_ANGLE_MAX_deg); }
