//
// Created by swpinkerton on 05/03/2023.
//

#ifndef UGR_FS_VCU_API_VCU_API_H
#define UGR_FS_VCU_API_VCU_API_H
...
// Enumerations
typedef enum ugr_vcu_api_as_state_e {
    AS_OFF = 1,
    AS_READY = 2,
    AS_DRIVING = 3,
...
typedef enum ugr_vcu_api_ami_state_e {
    AMI_NOT_SELECTED = 0,
    AMI_ACCELERATION = 1,
    AMI_SKIDPAD = 2,
    AMI_AUTOCROSS = 3,
...
} ugr_vcu_api_ami_state_e;


typedef enum ugr_vcu_api_handshake_receive_bit_e {
    HANDSHAKE_RECEIVE_BIT_OFF = 0,
    HANDSHAKE_RECEIVE_BIT_ON = 1,
} ugr_vcu_api_handshake_receive_bit_e;


typedef enum ugr_vcu_api_res_go_signal_bit_e {
    RES_GO_SIGNAL_NO_GO = 0,
    RES_GO_SIGNAL_GO = 1,
} ugr_vcu_api_res_go_signal_bit_e;
...
typedef enum ugr_vcu_api_mission_status_e {
    MISSION_NOT_SELECTED = 0,
    MISSION_SELECTED = 1,
    MISSION_RUNNING = 2,
    MISSION_FINISHED = 3,
} ugr_vcu_api_mission_status_e;


typedef enum ugr_vcu_api_direction_request_e {
    DIRECTION_NEUTRAL = 0,
    DIRECTION_FORWARD = 1,
} ugr_vcu_api_direction_request_e;


typedef enum ugr_vcu_api_estop_request_e {
    ESTOP_NO = 0,
    ESTOP_YES = 1,
} ugr_vcu_api_estop_request_e;


typedef enum ugr_vcu_api_handshake_send_bit_e {
    HANDSHAKE_SEND_BIT_OFF = 0,
    HANDSHAKE_SEND_BIT_ON = 1,
} ugr_vcu_api_handshake_send_bit_e;
...
void ugr_vcu_api_vcu2ai_get_data(ugr_vcu_api_vcu2ai *data);

void ugr_vcu_api_ai2vcu_set_data(ugr_vcu_api_ai2vcu *data);
...
#endif //UGR_FS_VCU_API_VCU_API_H
